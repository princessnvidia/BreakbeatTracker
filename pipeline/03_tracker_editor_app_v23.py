...
"""
BreakbeatAI Tracker Editor v23
...
def load_wav(path):
    ...
    # v23 : pas de normalisation/fade par sample.
...
class TrackerEditorApp:
    def __init__(self, root, pair_json):
        ...
        # v23 : grille musicale break8.
        # Une colonne = une position du pattern :
        ...
        self.root.title("BreakbeatAI Tracker Editor v23")
    ...
    def guess_step_ms(self):
        # v23 : une colonne = une position break8.
    ...
    def detect_external_player(self):
        for name in ["pw-play", "paplay", "aplay", "ffplay"]:
            ...
            if path:
                print(f"[v23] Backend audio système trouvé : {name} -> {path}")
                return name

        print("[v23] Aucun backend système trouvé, fallback sounddevice.")
        return None
    ...
    def build_ui(self):
        ...
        title = tk.Label(
            main,
            text="BreakbeatAI Tracker Editor v23 — break8 : snares sur 2 et 6",
            bg="#111018",
            fg="#ff7acc",
            font=("Sans", 20, "bold"),
        )
        ...
        subtitle = tk.Label(
            ...
            text=(
                ...
                "grille 8 positions : K H S H H K S H."
            ),
            bg="#111018",
            fg="#b9acc8",
        )
        ...
        self.output_label = tk.Label(
            panel,
            text="v23 : grille 8 positions. Les snares sont sur 2 et 6, pas sur 7.",
            bg="#1b1824",
            fg="#77f5b5",
            justify="left",
        )
    ...
    def bind_keys(self):
        ...
        print("[v23] Raccourcis : Espace loop | flèches = déplacer | Delete = supprimer")
    ...
    def play_audio_array(self, audio, label="audio"):
        ...
        live_wav = OUT_DIR / f"{self.project['safe']}_v23_live.wav"
        ...
        if self.external_player:
            ...
            try:
                ...
                print(f"[v23] {label} lancé avec {self.external_player} : {live_wav}")
                return duration_ms
            except Exception as exc:
                print(f"[v23] Erreur backend système {self.external_player} : {exc}")
    ...
    def draw(self):
        ...
        # Numéros de positions musicales 0..7 en haut.
    ...
    def render_preview_file(self):
        OUT_DIR.mkdir(parents=True, exist_ok=True)
        wav = OUT_DIR / f"{self.project['safe']}_tracker_app_v23_preview.wav"
    ...
    def toggle_loop(self):
        if self.looping:
            ...
            print("[v23] Loop arrêtée")
            return

        self.stop_playhead()
        print("[v23] Lancement loop...")
        self.looping = True
    ...
    def save(self):
        ...
        data = {
            "version": "tracker_app_edit_v23_exact_cells_no_sample_fade",
        ...
        path = OUT_DIR / f"{self.project['safe']}_tracker_app_edit_v23.json"
