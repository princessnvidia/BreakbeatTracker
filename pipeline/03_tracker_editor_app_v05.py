...
"""
03_tracker_editor_app_v05.py

BreakbeatAI Tracker Editor v05

Objectif :
- Corriger l'affichage en escalier.
- Retrouver une disposition claire par lignes :
    HI-HAT
    KICK
    SNARE
- Une case garde une position horizontale x_step.
- Sa position verticale est une lane fixe : hat/kick/snare.
- Le bloc audio joué reste "pair".
- L'audio reste rendu par ordre horizontal x_step.

Usage :
    cd ~/Applications/BreakbeatAI
    python pipeline/03_tracker_editor_app_v05.py --source "Amen"
"""
...
class TrackerEditorApp:
    def __init__(self, root, pair_json):
        ...
        self.root.title("BreakbeatAI Tracker Editor v05")
    ...
    def build_ui(self):
        ...
        title = tk.Label(
            main,
            text="BreakbeatAI Tracker Editor v05 — HI-HAT / KICK / SNARE alignés",
            bg="#111018",
            fg="#ff7acc",
            font=("Sans", 20, "bold"),
        )
        ...
        self.output_label = tk.Label(
            panel,
            text="Clic vide = nouvelle case. Drag vertical = change HI-HAT/KICK/SNARE. Pair audio séparée de la ligne.",
            bg="#1b1824",
            fg="#77f5b5",
            justify="left",
        )
    ...
    def play_selected_pair(self):
        ...
        try:
            ...
            messagebox.showwarning(
                "Audio",
                "Installe sounddevice : python -m pip install sounddevice",
            )
    ...
    def render_preview_file(self):
        ...
        wav = OUT_DIR / f"{self.project['safe']}_tracker_app_v05_preview.wav"
    ...
    def loop_tick(self):
        ...
        try:
            ...
            self.output_label.config(
                text="Installe sounddevice : python -m pip install sounddevice"
            )
    ...
    def save(self):
        ...
        data = {
            "version": "tracker_app_edit_v05_three_lanes_no_staircase",
        ...
        path = OUT_DIR / f"{self.project['safe']}_tracker_app_edit_v05.json"
