...
Usage :
    python pipeline/01_autoslice_all_index_v07.py --source "camo"
    python pipeline/01_autoslice_all_index_v07.py --source "amen"
...
OUT_DIR = Path("dataset/slice_indexes_v07")
...
def main():
    ...
    parser.add_argument("--min-sep-ms", type=float, default=25.0)
    ...
    preview_wav = out_dir / f"{safe}_source_loop_preview_v07.wav"
    ...
    data = {
        "version": "pair_blocks_v02_all_slices_index_only_v07",
        ...
        "slice_method": "all_transients_index_only_v07",
        "threshold": args.threshold,
        "min_sep_ms": args.min_sep_ms,
    ...
    report = out_dir / f"{safe}_all_slices_v07_report.txt"
    lines = []
    lines.append(f"All-slices index-only v07: {safe}")
    ...
    print("OK autoslice all-slices index-only v07")
