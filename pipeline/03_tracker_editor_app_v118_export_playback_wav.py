...
class SliceIndexTracker:
    ...
    def build_ui(self):
        ...
        title = tk.Label(
            main,
            text="BreakbeatAI v118 — export playback wav",
            bg="#111018",
            fg="#ff7acc",
            font=("Sans", 20, "bold"),
        )
...
def v81_build_ui(self):
    ...
    try:
        self.root.title(f"BreakbeatAI v118 — export playback wav")
    except Exception:
        pass
...
def v115_build_ui(self):
    ...
    try:
        self.root.title("BreakbeatAI v118 — export playback wav")
    except Exception:
        pass
...
def v118_current_break(self):
    ...
    if candidates:
        ...
        print("[v118] break courant:", stem, "| source:", source, "| raw:", raw)
        return stem

    print("[v118] WARNING : break courant introuvable, fallback Camo.")
    return "Camo_Break_-_3A"
...
def v118_find_best_playback_wav(since):
    ...
    print("")
    print("[v118] WAV candidats playback :")
    for score, mtime, size, wav in candidates[:12]:
        age = time.time() - mtime
        print(f"[v118] score={score:8d} age={age:7.2f}s size={size:10d} path={wav}")
    print("")
...
def v118_copy_playback_wav(self, since):
    ...
    if best is None:
        ...
        print("[v118] aucun WAV playback trouvé.")
        return "break"
    ...
    print("")
    print("[v118] EXPORT PLAYBACK OK")
    print("[v118] source :", best)
    print("[v118] export :", out)
    print("[v118] json   :", info_path)
    print("")
...
def v118_export_playback_wav(self, event=None):
    ...
    try:
        ...
        if btn is not None:
            print("[v118] déclenche Loop / Space pour générer le playback WAV...")
            btn.invoke()
        else:
            print("[v118] bouton Loop / Space introuvable, copie du dernier WAV playback existant.")
    except Exception as exc:
        print("[v118] invoke Loop / Space impossible :", exc)
