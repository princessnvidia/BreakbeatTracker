...
"""
03_tracker_editor_app_v14.py

BreakbeatAI Tracker Editor v14
...
Usage :
    ...
    python pipeline/03_tracker_editor_app_v14.py --source "amen"
"""
...
class TrackerEditorApp:
    def __init__(self, root, pair_json):
        ...
        # v14 : pas d’override automatique au lancement.
        ...
        self.root.title("BreakbeatAI Tracker Editor v14")
    ...
    def seed_known_overrides(self):
        ...
        if 1 in self.pair_values and "1" not in self.pair_role_overrides:
            ...
            print("[v14] Override auto confirmé : pair 1 = kick")
    ...
    def detect_external_player(self):
        for name in ["pw-play", "paplay", "aplay", "ffplay"]:
            ...
            if path:
                print(f"[v14] Backend audio système trouvé : {name} -> {path}")
                return name

        print("[v14] Aucun backend système trouvé, fallback sounddevice.")
        return None
    ...
    def bind_keys(self):
        ...
        print("[v14] Raccourcis : Espace loop | h/k/s/u = classer pair sélectionnée")
    ...
    def build_ui(self):
        ...
        title = tk.Label(
            main,
            text="BreakbeatAI Tracker Editor v14 — mode manuel, plus d’auto-snare/auto-hat",
            bg="#111018",
            fg="#ff7acc",
            font=("Sans", 20, "bold"),
        )
        ...
        self.output_label = tk.Label(
            panel,
            text="v14 : aucune classification automatique. Glisse les cases sur HI-HAT/KICK/SNARE. Les chiffres ne sont plus dessinés.",
            bg="#1b1824",
            fg="#77f5b5",
            justify="left",
        )
    ...
    def reanalyse_pairs(self):
        ...
        print("[v14] Analyse audio stricte :", counts)
    ...
    def build_initial_pattern_manual(self):
        """
        v14 : aucune auto-classification.
    ...
    def reset(self):
        ...
        self.draw()
        self.refresh_panel()
        self.output_label.config(text="Reset v14 : toutes les slices sont revenues dans À CLASSER, sans auto-classification.")
    ...
    def play_audio_array(self, audio, label="audio"):
        ...
        live_wav = OUT_DIR / f"{self.project['safe']}_v14_live.wav"
        ...
        if self.external_player:
            ...
            try:
                ...
                print(f"[v14] {label} lancé avec {self.external_player} : {live_wav}")
                return duration_ms
            except Exception as exc:
                print(f"[v14] Erreur backend système {self.external_player} : {exc}")

        try:
            import sounddevice as sd
            sd.play(audio, SR)
            self.output_label.config(text=f"{label} lancé avec sounddevice — {duration_ms} ms")
            print(f"[v14] {label} lancé avec sounddevice")
            return duration_ms
        except Exception as exc:
    ...
    def set_selected_pair_role(self, role):
        ...
        print(f"[v14] override pair {pair} = {role} -> {self.role_override_path}")
    ...
    def render_preview_file(self):
        OUT_DIR.mkdir(parents=True, exist_ok=True)
        wav = OUT_DIR / f"{self.project['safe']}_tracker_app_v14_preview.wav"
    ...
    def toggle_loop(self):
        if self.looping:
            ...
            print("[v14] Loop arrêtée")
            return

        self.stop_playhead()
        print("[v14] Lancement loop...")
        self.looping = True
    ...
    def save(self):
        ...
        data = {
            "version": "tracker_app_edit_v14_manual_lanes_no_box_numbers",
        ...
        path = OUT_DIR / f"{self.project['safe']}_tracker_app_edit_v14.json"
