...
"""
BreakbeatAI Tracker Editor v28
...
# v28 : rôle réel des samples/pairs.
...
def block_role(block):
    """
    v28 : rôle réel du sample.
    pair 5 et pair 6 sont override en hat, pair 7 est override en snare.
    """
    try:
...
def load_wav(path):
    ...
    # v28 : pas de normalisation/fade par sample.
...
class TrackerEditorApp:
    def __init__(self, root, pair_json):
        ...
        # v28 : grille 32 positions = 4 cycles de break8.
        ...
        self.root.title("BreakbeatAI Tracker Editor v28")
    ...
    def guess_step_ms(self):
        # v28 : une colonne = une position break8.
    ...
    def detect_external_player(self):
        for name in ["pw-play", "paplay", "aplay", "ffplay"]:
            ...
            if path:
                print(f"[v28] Backend audio système trouvé : {name} -> {path}")
                return name

        print("[v28] Aucun backend système trouvé, fallback sounddevice.")
        return None
    ...
    def formal_role_for_pair(self, pair):
        ...
        v28 : pair 5 = hat / pair 6 = hat / pair 7 = snare.
        """
        pair = int(pair)
    ...
    def base_pair_for_position(self, local_pos):
        ...
        Carte sample réelle v28 :
            5 = hat
            6 = hat
            7 = snare

        Donc :
            position 5 veut un kick   -> choisit un vrai kick disponible, pas pair 5
    ...
    def build_initial_pattern(self):
        ...
        print("[v28] Génération loop32 verrouillée")
        print("[v28] pattern =", " ".join(BREAK8_ROLES))
        ...
        for pos in range(32):
            ...
            if actual_role != target_role:
                print(
                    f"[v28][WARN] pos {pos}: target {target_role}, "
            ...
            print(
                f"[v28] pos {pos:02d} | target {target_role:5s} | "
    ...
    def build_ui(self):
        ...
        title = tk.Label(
            main,
            text="BreakbeatAI Tracker Editor v28 — pair 5 = hat / pair 6 = hat / pair 7 = snare",
            bg="#111018",
            fg="#ff7acc",
            font=("Sans", 20, "bold"),
        )
        ...
        self.output_label = tk.Label(
            panel,
            text="v28 : pair 5 et pair 6 sont des hats, pair 7 est une snare. Les positions restent K H S H H K S H.",
            bg="#1b1824",
            fg="#77f5b5",
            justify="left",
        )
    ...
    def bind_keys(self):
        ...
        print("[v28] Raccourcis : Espace loop | flèches = déplacer | Delete = supprimer")
    ...
    def play_audio_array(self, audio, label="audio"):
        ...
        live_wav = OUT_DIR / f"{self.project['safe']}_v28_live.wav"
        ...
        if self.external_player:
            ...
            try:
                ...
                print(f"[v28] {label} lancé avec {self.external_player} : {live_wav}")
                return duration_ms
            except Exception as exc:
                print(f"[v28] Erreur backend système {self.external_player} : {exc}")
    ...
    def render_preview_file(self):
        OUT_DIR.mkdir(parents=True, exist_ok=True)
        wav = OUT_DIR / f"{self.project['safe']}_tracker_app_v28_preview.wav"
    ...
    def toggle_loop(self):
        if self.looping:
            ...
            print("[v28] Loop arrêtée")
            return

        self.stop_playhead()
        print("[v28] Lancement loop...")
        self.looping = True
    ...
    def save(self):
        ...
        data = {
            "version": "tracker_app_edit_v28_exact_cells_no_sample_fade",
        ...
        path = OUT_DIR / f"{self.project['safe']}_tracker_app_edit_v28.json"
