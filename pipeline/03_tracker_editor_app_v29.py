...
"""
BreakbeatAI Tracker Editor v29
...
# v29 : rôle réel des samples/pairs.
...
def load_wav(path):
    ...
    # v29 : pas de normalisation/fade par sample.
...
class TrackerEditorApp:
    def __init__(self, root, pair_json):
        ...
        # v29 : grille 32 positions = 4 cycles de break8.
        ...
        self.root.title("BreakbeatAI Tracker Editor v29")
    ...
    def guess_step_ms(self):
        # v29 : une colonne = une position break8.
    ...
    def detect_external_player(self):
        for name in ["pw-play", "paplay", "aplay", "ffplay"]:
            ...
            if path:
                print(f"[v29] Backend audio système trouvé : {name} -> {path}")
                return name

        print("[v29] Aucun backend système trouvé, fallback sounddevice.")
        return None
    ...
    def formal_role_for_pair(self, pair):
        ...
        v29 : pair 1 = kick / pair 5 = hat / pair 6 = hat / pair 7 = snare.
        """
        pair = int(pair)
    ...
    def build_initial_pattern(self):
        ...
        print("[v29] Génération loop32 verrouillée")
        print("[v29] pattern =", " ".join(BREAK8_ROLES))
        ...
        for pos in range(32):
            ...
            if actual_role != target_role:
                print(
                    f"[v29][WARN] pos {pos}: target {target_role}, "
            ...
            print(
                f"[v29] pos {pos:02d} | target {target_role:5s} | "
    ...
    def build_ui(self):
        ...
        title = tk.Label(
            main,
            text="BreakbeatAI Tracker Editor v29 — pair 1 = kick / pair 5 = hat / pair 6 = hat / pair 7 = snare",
            bg="#111018",
            fg="#ff7acc",
            font=("Sans", 20, "bold"),
        )
        ...
        self.output_label = tk.Label(
            panel,
            text="v29 : pair 1 est un kick, pair 5 et pair 6 sont des hats, pair 7 est une snare. Les positions restent K H S H H K S H.",
            bg="#1b1824",
            fg="#77f5b5",
            justify="left",
        )
    ...
    def bind_keys(self):
        ...
        print("[v29] Raccourcis : Espace loop | flèches = déplacer | Delete = supprimer")
    ...
    def play_audio_array(self, audio, label="audio"):
        ...
        live_wav = OUT_DIR / f"{self.project['safe']}_v29_live.wav"
        ...
        if self.external_player:
            ...
            try:
                ...
                print(f"[v29] {label} lancé avec {self.external_player} : {live_wav}")
                return duration_ms
            except Exception as exc:
                print(f"[v29] Erreur backend système {self.external_player} : {exc}")
    ...
    def render_preview_file(self):
        OUT_DIR.mkdir(parents=True, exist_ok=True)
        wav = OUT_DIR / f"{self.project['safe']}_tracker_app_v29_preview.wav"
    ...
    def toggle_loop(self):
        if self.looping:
            ...
            print("[v29] Loop arrêtée")
            return

        self.stop_playhead()
        print("[v29] Lancement loop...")
        self.looping = True
    ...
    def save(self):
        ...
        data = {
            "version": "tracker_app_edit_v29_exact_cells_no_sample_fade",
        ...
        path = OUT_DIR / f"{self.project['safe']}_tracker_app_edit_v29.json"
