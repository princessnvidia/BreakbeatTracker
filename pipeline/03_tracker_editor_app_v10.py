...
"""
03_tracker_editor_app_v10.py

BreakbeatAI Tracker Editor v10
...
class TrackerEditorApp:
    def __init__(self, root, pair_json):
        ...
        self.root.title("BreakbeatAI Tracker Editor v10")
    ...
    def detect_external_player(self):
        for name in ["pw-play", "paplay", "aplay", "ffplay"]:
            ...
            if path:
                print(f"[v10] Backend audio système trouvé : {name} -> {path}")
                return name

        print("[v10] Aucun backend système trouvé, fallback sounddevice.")
        return None
    ...
    def build_ui(self):
        ...
        title = tk.Label(
            main,
            text="BreakbeatAI Tracker Editor v10 — correction manuelle des KICK / SNARE / HI-HAT",
            bg="#111018",
            fg="#ff7acc",
            font=("Sans", 20, "bold"),
        )
        ...
        subtitle = tk.Label(
            ...
            text=(
                ...
                "Si une pair est mal reconnue, sélectionne-la puis clique Pair = KICK / HAT / SNARE."
            ),
            bg="#111018",
            fg="#b9acc8",
        )
    ...
    def bind_keys(self):
        ...
        print("[v10] Raccourcis : Espace loop | h/k/s = classer pair sélectionnée")
    ...
    def play_audio_array(self, audio, label="audio"):
        ...
        live_wav = OUT_DIR / f"{self.project['safe']}_v10_live.wav"
        ...
        if self.external_player:
            ...
            try:
                ...
                print(f"[v10] {label} lancé avec {self.external_player} : {live_wav}")
                return duration_ms
            except Exception as exc:
                print(f"[v10] Erreur backend système {self.external_player} : {exc}")
        ...
        try:
            ...
            print(f"[v10] {label} lancé avec sounddevice")
            return duration_ms
        except Exception as exc:
    ...
    def set_selected_pair_role(self, role):
        ...
        print(f"[v10] override pair {pair} = {role} -> {self.role_override_path}")
    ...
    def render_preview_file(self):
        OUT_DIR.mkdir(parents=True, exist_ok=True)
        wav = OUT_DIR / f"{self.project['safe']}_tracker_app_v10_preview.wav"
    ...
    def toggle_loop(self):
        if self.looping:
            ...
            print("[v10] Loop arrêtée")
            return

        print("[v10] Lancement loop...")
        self.looping = True
    ...
    def save(self):
        ...
        data = {
            "version": "tracker_app_edit_v10_manual_pair_role_overrides",
        ...
        path = OUT_DIR / f"{self.project['safe']}_tracker_app_edit_v10.json"
